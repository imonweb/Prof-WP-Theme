 ...
 * Description: Gym Fitness Plugin - Adds a Custom Widget in the WP Panel
 * Author: Imon
...
class GymFitness_Classes_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			array( 'description' => esc_html__( 'Displays different classes in the the widget', 'text_domain' ), ) // Args
		);
	}
